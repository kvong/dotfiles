...
keys = [
    ...
    Key([mod], "h", lazy.layout.left(), lazy.layout.down().when(layout='ratiotile'), desc="Move focus to left"),
    Key([mod], "l", lazy.layout.right(), lazy.layout.up().when(layout='ratiotile'), desc="Move focus to right"),

    Key([mod], "space", lazy.layout.next(), desc="Move window focus to other window"),
    
    # Move
    Key([mod, "shift"], "h", lazy.layout.shuffle_left(), lazy.layout.shuffle_down().when(layout='ratiotile'), desc="Move window to the left"),
    Key([mod, "shift"], "l", lazy.layout.shuffle_right(), lazy.layout.shuffle_up().when(layout='ratiotile'), desc="Move window to the right"),
    ...
    # Size
    Key([mod, "control"], "j", lazy.layout.shrink(), desc="Grow window to the left"),
    Key([mod, "control"], "k", lazy.layout.grow(), desc="Grow window to the right"),
