...
keymap({"n", "v"}, "<leader>o", "<cmd>lua require('vscode').action('editor.action.openLink')<CR>")
keymap({"n", "v"}, "<leader>b", "<cmd>lua require('vscode').action('workbench.action.navigateLast')<CR>")
...
keymap({"n", "v"}, "<leader>aa", "<cmd>lua require('vscode').action('workbench.action.chat.open')<CR>")
keymap({"n", "v"}, "<leader>aa", "<cmd>lua require('vscode').action('workbench.action.chat.open')<CR>")
keymap({"n", "v"}, "<leader>oo", "<cmd>lua require('vscode').action('workbench.action.showAllEditors')<CR>")
keymap({"n", "v"}, "<leader>v", "<cmd>lua require('vscode').action('workbench.action.splitEditor')<CR>")
keymap({"n", "v"}, "<leader>e", "<cmd>lua require('vscode').action('workbench.action.focusActiveEditorGroup')<CR>")
...
keymap({"n", "v"}, "<leader>ml", "<cmd>lua require('vscode').action('projectManager.listProjectsNewWindow')<CR>")
